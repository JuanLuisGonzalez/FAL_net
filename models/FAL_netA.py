# FAL_netA.py This script contains the network architecture of FAL_netA
...
class BackBone(nn.Module):
    def __init__(self, batchNorm=True, no_in=3, no_flow=1, no_out=64):
        ...
        self.conv3 = conv_elu(self.batchNorm, 128, 128, pad=1, stride=2)
        self.conv3_1 = residual_block(128)
        self.conv4 = conv_elu(self.batchNorm, 128, 256, pad=1, stride=2)
        self.conv4_1 = residual_block(256)
        self.conv5 = conv_elu(self.batchNorm, 256, 256, pad=1, stride=2)
        self.conv5_1 = residual_block(256)
        self.conv6 = conv_elu(self.batchNorm, 256, 256, pad=1, stride=2)
        self.conv6_1 = residual_block(256)
        self.elu = nn.ELU(inplace=True)

        # i and up convolutions
        self.deconv6 = deconv(256, 128)
        self.iconv6 = conv_elu(self.batchNorm, 128 + 256, 256)
        self.deconv5 = deconv(256, 128)
        self.iconv5 = conv_elu(self.batchNorm, 128 + 256, 256)
        self.deconv4 = deconv(256, 128)
        self.iconv4 = conv_elu(self.batchNorm, 128 + 128, 128)
        self.deconv3 = deconv(128, 64)
        self.iconv3 = conv_elu(self.batchNorm, 128 + 64, 128)
