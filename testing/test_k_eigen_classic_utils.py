...
from imageio import imread  # import library
...
def get_focal_length_baseline(calib_dir, cam):
    cam2cam = read_calib_file(calib_dir + "_calib_cam_to_cam.txt")
...
def generate_depth_map(
    ...
    cam2cam = read_calib_file(calib_dir + "_calib_cam_to_cam.txt")
    velo2cam = read_calib_file(calib_dir + "_calib_velo_to_cam.txt")
...
class EvalDataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        input = imread("{:010d}.png".format(index))
...
def main(
    ...
    res1 = "{:>10}, {:>10}, {:>10}, {:>10}, {:>10}, {:>10}, {:>10}, {:>10}".format(
        "abs_rel", "sq_rel", "rms", "log_rms", "d1_all", "a1", "a2", "a3"
    )
    res2 = "{:10.4f}, {:10.4f}, {:10.3f}, {:10.3f}, {:10.3f}, {:10.3f}, {:10.3f}, {:10.3f}".format(
        abs_rel.mean(),
        sq_rel.mean(),
        rms.mean(),
        log_rms.mean(),
